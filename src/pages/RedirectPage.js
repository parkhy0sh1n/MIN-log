    ...
    <Container>
      ...
      <BtnWrapper>
        <a href="https://www.google.com/chrome">
          <Btn
            src={`${process.env.PUBLIC_URL}/icons/browsers/chrome.png`}
            alt="Chrome"
          />
        </a>
        <a href="https://www.microsoft.com/ko-kr/edge">
          <Btn
            src={`${process.env.PUBLIC_URL}/icons/browsers/edge.png`}
            alt="Edge"
          />
        </a>
        <a href="https://whale.naver.com/ko/download">
          <Btn
            src={`${process.env.PUBLIC_URL}/icons/browsers/whale.png`}
            alt="Whale"
          />
        </a>
      </BtnWrapper>
